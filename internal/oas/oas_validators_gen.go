...
func (s *ContactUsReq) Validate() error {
	if s == nil {
...
func (s *GetProductOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *InvoiceSummary) Validate() error {
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.PaidAmount)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
...
func (s *ListInvoicesOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s OrderItemDisposition) Validate() error {
	switch s {
	case "unspecified":
		return nil
	case "backorder":
...
func (s *OrderItemRelease) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.ReleasedQuantity)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
	...
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.CanceledQuantity)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
...
func (s *Product) Validate() error {
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := s.SalesUnitOfMeasurement.Validate(); err != nil {
			return err
		}
		return nil
	}(); err != nil {
		failures = append(failures, validate.FieldError{
			Name:  "sales_unit_of_measurement",
			Error: err,
		})
	}
	if len(failures) > 0 {
...
func (s *UnitOfMeasurement) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.ConversionFactor)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
