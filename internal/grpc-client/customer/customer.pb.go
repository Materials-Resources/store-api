...
// Deprecated: Use GetRecentPurchasesByBranchRequest.ProtoReflect.Descriptor instead.
func (*GetRecentPurchasesByBranchRequest) Descriptor() ([]byte, []int) {
...
func (x *GetRecentPurchasesByBranchRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type GetRecentPurchasesByBranchResponse struct {
	...
	Items []*GetRecentPurchasesByBranchResponse_Item `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}
...
// Deprecated: Use GetRecentPurchasesByBranchResponse.ProtoReflect.Descriptor instead.
func (*GetRecentPurchasesByBranchResponse) Descriptor() ([]byte, []int) {
...
type GetRecentPurchasesByBranchResponse_Item struct {
	...
	OrderedQuantity    float64 `protobuf:"fixed64,5,opt,name=ordered_quantity,json=orderedQuantity,proto3" json:"ordered_quantity,omitempty"`
...
// Deprecated: Use GetRecentPurchasesByBranchResponse_Item.ProtoReflect.Descriptor instead.
func (*GetRecentPurchasesByBranchResponse_Item) Descriptor() ([]byte, []int) {
	return file_customer_proto_rawDescGZIP(), []int{7, 0}
}
...
var file_customer_proto_rawDesc = []byte{
	...
	0x49, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x50, 0x75, 0x72, 0x63,
	...
	0x01, 0x28, 0x05, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0xd3, 0x02, 0x0a, 0x22, 0x47,
	0x65, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65,
	...
	0x32, 0x34, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	0x65, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65,
	0x73, 0x42, 0x79, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0xe0, 0x01,
	...
	0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x73, 0x42,
	0x79, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x62,
...
func file_customer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_customer_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*GetRecentPurchasesByBranchRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_customer_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*GetRecentPurchasesByBranchResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_customer_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*GetRecentPurchasesByBranchResponse_Item); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
