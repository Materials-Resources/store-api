...
func (x *GetRecentPurchasesByBranchRequest) SetLimit(v int32) {
...
func (x *GetRecentPurchasesByBranchRequest) HasLimit() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
func (x *GetRecentPurchasesByBranchRequest) ClearLimit() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
